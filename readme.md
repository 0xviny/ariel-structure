...
Ariel é um simples bot para a plataforma Discord, que foi criado por mim `(darly.js)` com o intuito de alegrar e ajudar o seu servidor. Hoje, estou deixando a estrutura da Ariel aberta para todo o público, para que saibam, pelo menos, como ela foi criada.
